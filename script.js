...
class CampusConnect {
  ...
  setupEventListeners() {
    ...
    if (createPostForm)
      createPostForm.addEventListener(
        "submit",
        this.handleCreatePost.bind(this)
      );
  ...
  updateAuthUI() {
    ...
    if (this.isLoggedIn && this.currentUser) {
      ...
      document
        ...
        .addEventListener("click", () => this.showModal("login-modal"));
      document
        .getElementById("register-btn")
        .addEventListener("click", () => this.showModal("register-modal"));
    }
  }
  ...
  handleEditProfile(e) {
    ...
    this.currentUser.skills = document
      .getElementById("edit-skills")
      .value.split(",")
      .map((s) => s.trim())
      .filter(Boolean);
    this.currentUser.interests = document
  ...
  updateProfileDisplay() {
    if (!this.currentUser || !document.querySelector(".profile-container"))
      return;
    ...
    document.getElementById("profile-major").textContent =
      this.currentUser.major;

    const skillsContainer = document.getElementById("skills-container");
    skillsContainer.innerHTML = this.currentUser.skills
    ...
    document.getElementById("edit-skills").value =
      this.currentUser.skills.join(", ");
    document.getElementById("edit-interests").value =
      this.currentUser.interests.join(", ");
  }
  ...
  handleCreatePost(e) {
    ...
    const tags = document
      ...
      .filter((tag) => tag);
    const authorName =
      this.isLoggedIn && this.currentUser ? this.currentUser.name : "Anonymous";
          ...
          post.content.length > 150 ? "..." : ""
                ...
                <div class="post-footer">
                    <div class="post-actions">
                        <span class="post-action" onclick="campusConnect.likePost(${
                          post.id
                        })">
                            <i class="fas fa-heart"></i> ${post.likes}
                        </span>
                        <span class="post-action"><i class="fas fa-comment"></i> ${
                          post.comments
                        }</span>
  ...
  renderUserPosts() {
    ...
    const userPosts = this.posts.filter(
      (post) => post.author === this.currentUser.name
    );
      ...
      .map(
        (post) => `
            <div class="post-card" style="margin-bottom: 20px;">
                ...
                <div class="post-content"><p>${post.content.substring(
                  0,
                  100
                )}...</p></div>
                <div class="post-footer"><div class="post-date">${
                  post.date
                }</div></div>
            </div>
        `
    ...
    this.posts = [
      {
        ...
        category: "project",
        content:
          "We're building a modern e-commerce platform using React and Node.js. Looking for a frontend developer with experience in React hooks, Redux, and modern CSS frameworks.",
      ...
      },
      {
        ...
        category: "study",
        content:
          "Forming a study group for CS 229 Machine Learning. We meet twice a week to discuss assignments and prepare for exams. All skill levels welcome!",
      ...
      },
      {
        ...
        category: "resource",
        content:
          "Sharing a collection of free Python tutorials and coding challenges. Perfect for beginners and intermediate learners.",
      ...
      },
      {
        ...
        category: "event",
        content:
          "Join us for an exciting tech talk by Dr. Emily Watson on AI applications in healthcare. Free pizza and networking after the talk!",
      ...
      },
      {
        ...
        category: "project",
        content:
          "Looking for iOS and Android developers to join our startup team. We're building a social networking app for students. Equity-based compensation available.",
      ...
      },
      {
        ...
        category: "resource",
        content:
          "Comprehensive notes and practice problems for Database Systems course. Covers SQL, normalization, indexing, and query optimization.",
